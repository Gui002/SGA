...
public class TelaLogin extends JFrame{
    ...
    public TelaLogin(){
        ...
        Sizer.resizeRelativeTo(btLogin, pnForm, .2f, .05f);
        ...
        ComponentPlacer.colocarEm(pnForm, btLogin, ComponentPlacer.MIDDLE, ComponentPlacer.BOTTOM);
        ComponentPlacer.offset(btLogin, 0, -40);
